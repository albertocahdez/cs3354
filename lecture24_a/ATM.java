...
{  
   ...
   public static final int TRANSACT_DEPOSIT = 51;
   public static final int TRANSACT_WITHDRAW = 52;
   ...
   */
   ...
   /** 
      Sets state to TRANSACT_WITHDRAW or TRANSACT_DEPOSIT. 
      (Precondition: state is TRANSACT)
   */
   public void selectTransaction(int transaction)
   {
      if (state == TRANSACT && ( transaction == TRANSACT_DEPOSIT || transaction == TRANSACT_WITHDRAW) )
      {
            state = transaction;
      }
   }
   ...
   */
   public void back()
   {
      if (state == TRANSACT_WITHDRAW || state == TRANSACT_DEPOSIT ) {
         state = TRANSACT;
